import{initializeApp as A}from"https://www.gstatic.com/firebasejs/10.12.0/firebase-app.js";import{getDatabase as k,push as w,ref as a,set as g,get as y,update as b,remove as E,onValue as f}from"https://www.gstatic.com/firebasejs/10.12.0/firebase-database.js";import{getAuth as L,signInWithEmailAndPassword as O,signOut as j,onAuthStateChanged as D}from"https://www.gstatic.com/firebasejs/10.12.0/firebase-auth.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const d of r.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&i(d)}).observe(document,{childList:!0,subtree:!0});function n(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=n(o);fetch(o.href,r)}})();const S={apiKey:"AIzaSyBwVEea-5FQulW4JQZgJMMwIZiUVXjopMY",authDomain:"retro-q.firebaseapp.com",databaseURL:"https://retro-q-default-rtdb.europe-west1.firebasedatabase.app",projectId:"retro-q",storageBucket:"retro-q.firebasestorage.app",messagingSenderId:"1035131215370",appId:"1:1035131215370:web:1c01668eabde570f8b49f3"},I=A(S),l=k(I),$=L(I),s={user:"",isAdmin:!1,sprint:"Sprint 1",team:[],demos:[],openDemo:null,replyOpen:null,editingAns:null,_picked:null};function c(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function h(e){return e.replace(/\\/g,"\\\\").replace(/'/g,"\\'")}function x(e,t,n){const i=document.createElement("a");i.href=URL.createObjectURL(new Blob([t],{type:n})),i.download=e,i.click()}window._signIn=async function(){const e=document.getElementById("auth-email").value.trim(),t=document.getElementById("auth-password").value,n=document.getElementById("auth-error");n.style.display="none";try{await O($,e,t)}catch{n.textContent="Incorrect email or password.",n.style.display="block"}};window._signOut=async function(){await j($)};window._selectMember=function(e,t){s._picked=t,document.querySelectorAll("#team-grid .member-tile").forEach(n=>n.classList.remove("selected")),e.classList.add("selected"),document.getElementById("btn-enter").disabled=!1};window.enterApp=()=>{s._picked&&(s.user=s._picked,s.isAdmin=!1,B())};window.enterAdmin=()=>{s.user="Admin",s.isAdmin=!0,B()};window.switchUser=()=>{s.user="",s.isAdmin=!1,s._picked=null,document.querySelectorAll("#team-grid .member-tile").forEach(e=>e.classList.remove("selected")),document.getElementById("btn-enter").disabled=!0,document.getElementById("btn-switch-user").style.display="none",document.getElementById("tab-admin").style.display="none",document.getElementById("overlay").style.display="flex"};window.switchTab=e=>{document.getElementById("tab-qa").classList.toggle("active",e==="qa"),document.getElementById("tab-admin").classList.toggle("active",e==="admin"),document.getElementById("view-qa").classList.toggle("hidden",e!=="qa"),document.getElementById("view-admin").classList.toggle("hidden",e!=="admin")};window._toggleDemo=function(e){s.openDemo=s.openDemo===e?null:e,v()};window._postQ=async function(e){const t=document.getElementById(`qt-${e}`),n=t==null?void 0:t.value.trim();if(!n){t==null||t.focus();return}const i=w(a(l,`demos/${e}/questions`));await g(i,{author:s.user,text:n,votes:0,intent:null,answer:""}),t.value=""};window._vote=async function(e,t){const n=btoa(s.user).replace(/=/g,""),i=`demos/${t}/questions/${e}`,o=a(l,`${i}/voters/${n}`);if((await y(o)).exists())return;const u=(await y(a(l,`${i}/votes`))).val()||0;await b(a(l,i),{votes:u+1,[`voters/${n}`]:!0})};window._setQIntent=async function(e,t,n){await b(a(l,`demos/${t}/questions/${e}`),{intent:n})};window._saveQAnswer=async function(e,t){var i;const n=((i=document.getElementById(`qwat-${e}`))==null?void 0:i.value)||"";await b(a(l,`demos/${t}/questions/${e}`),{answer:n}),s.editingAns=null,v()};window._toggleEditAns=function(e){s.editingAns=s.editingAns===e?null:e,v()};window._toggleReplyForm=function(e){if(s.replyOpen!==e){const t=document.getElementById(`rt-${e}`);t&&(t.value="")}s.replyOpen=s.replyOpen===e?null:e,v()};window._postReply=async function(e,t){const n=document.getElementById(`rt-${e}`),i=n==null?void 0:n.value.trim();if(!i){n==null||n.focus();return}const o=w(a(l,`demos/${t}/questions/${e}/replies`));await g(o,{author:s.user,text:i,timestamp:Date.now()}),n&&(n.value=""),s.replyOpen=null,v()};window._flagDiscuss=async function(e,t){const n=w(a(l,`demos/${t}/questions/${e}/discussFlaggers`));await g(n,s.user)};window.saveConfig=async function(){const e=document.getElementById("cfg-sprint").value.trim();e&&await g(a(l,"sprint"),e)};window.addMember=async function(){const e=document.getElementById("new-member"),t=e.value.trim();if(!t||s.team.includes(t))return;const n=w(a(l,"team"));await g(n,t),e.value=""};window._removeMember=async function(e){const t=await y(a(l,"team"));if(!t.val())return;const n=Object.entries(t.val()).find(([,i])=>i===e);n&&await E(a(l,`team/${n[0]}`)),p===e&&(p=null)};window.addDemo=async function(){const e=p,t=document.getElementById("new-demo-t").value.trim();if(!e||!t)return;const n=w(a(l,"demos"));await g(n,{presenter:e,topic:t}),p=null,document.getElementById("new-demo-t").value="",_()};window._removeDemo=async function(e){await E(a(l,`demos/${e}`)),s.openDemo===e&&(s.openDemo=null)};window._pickPresenter=function(e,t){p=t,document.querySelectorAll("#demo-presenter-grid .member-tile").forEach(n=>n.classList.remove("selected")),e.classList.add("selected")};window.exportMarkdown=function(){let e=`# ${s.sprint} — Retrospective Q&A
...
`})}),x(`${s.sprint.replace(/\s+/g,"-")}-retro.md`,e,"text/markdown")};window.exportJSON=function(){x(`${s.sprint.replace(/\s+/g,"-")}-retro.json`,JSON.stringify({sprint:s.sprint,demos:s.demos},null,2),"application/json")};function M(){f(a(l,"sprint"),e=>{s.sprint=e.val()||"Sprint 1",document.getElementById("h-sprint").textContent=s.sprint;const t=document.getElementById("cfg-sprint");t&&document.activeElement!==t&&(t.value=s.sprint)}),f(a(l,"team"),e=>{s.team=e.val()?Object.values(e.val()):[],R(),_(),F()}),f(a(l,"demos"),e=>{const t=e.val()||{};s.demos=Object.entries(t).map(([n,i])=>({id:n,presenter:i.presenter||"",topic:i.topic||"",questions:i.questions?Object.entries(i.questions).map(([o,r])=>({id:o,author:r.author||"",text:r.text||"",votes:r.votes||0,intent:r.intent||null,answer:r.answer||"",discussFlaggers:r.discussFlaggers?Object.values(r.discussFlaggers):[],replies:r.replies?Object.entries(r.replies).map(([d,u])=>({id:d,author:u.author||"",text:u.text||""})):[],voters:r.voters||{}})):[]})),v(),Q(),q()})}function R(){const e=document.getElementById("team-grid");if(e){if(!s.team.length){e.innerHTML='<div style="color:var(--muted);font-style:italic;font-size:.85rem;grid-column:1/-1">No members.</div>';return}e.innerHTML=s.team.map(t=>`
    <div class="member-tile${s._picked===t?" selected":""}" onclick="window._selectMember(this,'${h(t)}')">
      ...
      </div>`;else if(e.answer||e.intent){const m=e.answer?`<div class="q-answer-text">${c(e.answer)}</div>`:'<div class="q-answer-text" style="font-style:italic; color:var(--muted);">No written answer yet.</div>';d=`
      <div class="q-answer-block">
        ...
        ${m}
      </div>`}else o&&(d=`<button class="it-btn" onclick="window._toggleEditAns('${e.id}')" style="margin-top:8px;">+ Add Official Answer</button>`);const u=e.replies.length>0?`
    ...
    </div> </div>`}function F(){const e=document.getElementById("admin-member-list");e&&(e.innerHTML=s.team.map(t=>`<div class="member-row"><span>${c(t)}</span><button onclick="window._removeMember('${h(t)}')">✕</button></div>`).join(""))}function Q(){const e=document.getElementById("admin-demo-list");e&&(e.innerHTML=s.demos.map(t=>`<div class="demo-admin-row"><span>${c(t.topic)}</span><button onclick="window._removeDemo('${t.id}')">✕</button></div>`).join(""))}function q(){const e=s.demos.reduce((t,n)=>t+n.questions.length,0);document.getElementById("stat-demos")&&(document.getElementById("stat-demos").textContent=s.demos.length),document.getElementById("stat-qs")&&(document.getElementById("stat-qs").textContent=e)}let p=null;function _(){const e=document.getElementById("demo-presenter-grid");e&&(e.innerHTML=s.team.map(t=>`<div class="member-tile${p===t?" selected":""}" onclick="window._pickPresenter(this,'${h(t)}')">${c(t)}</div>`).join(""))}D($,e=>{e?(document.getElementById("login-screen").style.display="none",document.getElementById("overlay").style.display="flex",M()):(document.getElementById("login-screen").style.display="flex",document.getElementById("overlay").style.display="none")});
